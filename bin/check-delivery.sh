...
if [ "${1:-}" = "--self-test" ]; then
  ...
  _dirs="_st_ac1 _st_ac2 _st_ac4a _st_ac4b _st_ac5 _st_f2i _st_f2ii _st_ac7 _st_ac9 _st_ws _st_pfabs _st_pffail _st_pfwaiver _st_pfbareack _st_pfexpired _st_pfbad _st_confirm _st_wd _st_wdrepl _st_abandon _st_wdmask"
