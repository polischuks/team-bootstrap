...
|---|---|---|
| Role playbooks (`references/roles/*.md`) | 42 | New role → PATCH (new sanctioned enumeration entry) + role-matrix row + schema branch + skills-manifest entry |
| Pipelines (`references/pipelines/*.md`) | 5 | New pipeline → MINOR (new doctrine surface) |
